...
namespace BookStore_MVC.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        {
            // Projection - pick certain columns and convert
            ...
            // Pass values to view using ViewBag
            //ViewBag.CategoryList = CategoryList;

            // Pass values to view using ViewData - model specific for a view
            //ViewData["CategoryList"] = CategoryList;

            // another method is using ViewModels - directory
            ...
            if (ModelState.IsValid)
            {
                ...
                if (file != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(productVM.Product.ImageUrl))
                    {
                        ...
                        var oldImagePath = Path.Combine(wwwRootPath, @"images\products", productVM.Product.ImageUrl.TrimStart('\\'));
